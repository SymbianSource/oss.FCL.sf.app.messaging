...
// ----------------------------------------------------
// MsvUiServiceUtilities::CallToSenderQueryL
//
// Deprecated!
// ----------------------------------------------------
EXPORT_C TBool MsvUiServiceUtilities::CallToSenderQueryL( 
    const TDesC& aNumber,
    const TDesC& aName, 
...
// ----------------------------------------------------
// MsvUiServiceUtilities::InternetCallToSenderQueryL
//
// Deprecated!
// ----------------------------------------------------
EXPORT_C TBool MsvUiServiceUtilities::InternetCallToSenderQueryL( 
    const TDesC& aNumber,
    const TDesC& aName, 
    TBool aDialWithoutQueries )
    {
...
// ----------------------------------------------------
// MsvUiServiceUtilities::DefaultServiceForMTML
//
// Deprecated!
// ----------------------------------------------------
EXPORT_C TMsvId MsvUiServiceUtilities::DefaultServiceForMTML(
    CMsvSession& aSession,
    TUid aMtm,
    TBool aFindFirstServiceIfNoDefault )
    {
    return MsvUiServiceUtilitiesInternal::DefaultServiceForMTML(
        aSession,
        aMtm,
...
// ----------------------------------------------------
// MsvUiServiceUtilities::InternetCallServiceL
//
// Deprecated!
// ----------------------------------------------------

EXPORT_C TBool MsvUiServiceUtilities::InternetCallServiceL( 
