...
* Contributors:
*
* Description: clockwipetransitionfilter  declaration
*
*/


#ifndef CCLOCKWIPETRANSITIONFILTER_H
#define CCLOCKWIPETRANSITIONFILTER_H
...
/**
*  Clock wipe transition filter.
*
*  @lib smiltran.lib
*  @since S60 2.1
*/
NONSHARABLE_CLASS( CClockWipeTransitionFilter ) : public CSmilTransitionFilter, 
    ...
    public:  // Constructors and destructor
        ...
        */
        static CClockWipeTransitionFilter* NewL( CSmilTransition* aTransition, 
                                                 CFbsBitmap* aBuffer, 
                                                 MSmilMedia* aMedia );
...
#endif // CCLOCKWIPETRANSITIONFILTER_H
