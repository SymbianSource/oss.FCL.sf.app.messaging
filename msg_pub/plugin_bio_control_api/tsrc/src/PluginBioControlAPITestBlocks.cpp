...
void CPluginBioControlAPITest::Delete() 
    ...
    if( iBioControl )
        {
        CCoeEnv::Static()->AppUi()->RemoveFromStack( iBioControl );        
        delete iBioControl;
        iBioControl = NULL;
        iEdwinTestCtrl = NULL;
        }
...
TInt CPluginBioControlAPITest::RunMethodL( 
    ...
    static TStifFunctionInfo const KFunctions[] =
        ...
        ENTRY( "RBioOfferKeyEventTestL", CPluginBioControlAPITest::RBioOfferKeyEventTestL ),
        //ADD NEW ENTRY HERE^
...
// -----------------------------------------------------------------------------
// CPluginBioControlAPITest::RBioOfferKeyEventTestL
// Tests CRichBio's NewL
// -----------------------------------------------------------------------------
//
TInt CPluginBioControlAPITest::RBioOfferKeyEventTestL( CStifItemParser& /*aItem*/ )
    {
    _LIT( KTestEntry, "Entry RBioOfferKeyEventTestL Tests CRichBio::OfferKeyEventL");
    iLog->Log( KTestEntry );
    InitL();
    CreateEdwinL();
    iBioControl->SetContainerWindowL( *iEdwinTestCtrl );
    _LIT(KTestExit, "Exit RBioOfferKeyEventTestL CRichBio::OfferKeyEventL Passed");
    iLog->Log( KTestExit );
    return KErrNone;
    }
...
void CPluginBioControlAPITest::InitL( )
    ...
    if( iBioControl )
        ...
        if( err != KErrNone )
            ...
            iLog->Log( KErrBio );
            CCoeEnv::Static()->AppUi()->AddToStackL( iBioControl );
            }        
        }
    }
