...
// ---------------------------------------------------------
// CUniDataModel::CorruptedCount
// ---------------------------------------------------------
//
inline TInt CUniDataModel::CorruptedCount() const
    {
    return iCorruptedCount;
    }

// ---------------------------------------------------------
// CUniDataModel::OriginalAttachmentCount
// ---------------------------------------------------------
//
inline TInt CUniDataModel::OriginalAttachmentCount() const
    {
    return iOrigAttachmentCount;
    }

// ---------------------------------------------------------
// CUniDataModel::FsSession
// ---------------------------------------------------------
//
inline RFs& CUniDataModel::FsSession() const
    {
    return iFs;
    }
...
// ---------------------------------------------------------
//
inline CBaseMtm& CUniDataModel::Mtm() const
    {
    return iMtm;
    }
